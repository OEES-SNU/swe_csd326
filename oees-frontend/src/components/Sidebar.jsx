...
const navByRole = {
  ...
  STUDENT: [
    ...
    { to: '/student/exams', icon: icons.available, label: 'Available Exams' },
    { to: '/student/results', icon: icons.results, label: 'My Results' },
  ],
}
...
export default function Sidebar() {
  ...
  return (
    <aside className="w-60 flex-shrink-0 bg-white border-r border-gray-100 flex flex-col h-screen sticky top-0 shadow-sm">
      {/* Logo */}
      <div className="px-5 py-5 border-b border-gray-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="text-sm font-bold text-gray-900 tracking-tight">OEES</span>
            <p className="text-xs text-gray-400 leading-none mt-0.5">Exam Portal</p>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-gray-100 px-3 py-3">
        ...
        <button
          onClick={logout}
          className="w-full mt-1 flex items-center gap-2 px-3 py-2 text-sm text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-150"
        >
